function [params, D] = bpdict(params)
%BPPCT Blood-brain barrier permeability computation in perfusion CT.
%  [params] = BPDICT(PARAMS) denoises the specified (possibly
...
%
%  See also SPAMS, BPLASSO
%
%  Ruogu Fang 06/26/2012 Revise
%   3/13/2013 Change to BPPCT for BBBP calculation
